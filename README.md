...
with internal signaling networks,
progressive fate regulation,
and intent-based world interaction.

Instead of treating cells as simple state machines,
MacroImmunet organizes biological simulation into
world topology scanning,
