...
class RuntimeStatistics:
    ...
    viruses_by_type: Dict[str, int] = field(
        default_factory=dict
    )
...
class Statistics:
    ...
    def compute(
        ...
        stats = RuntimeStatistics(
            ...
            virus_count=len(snapshot.viruses),
        ...
        stats.viruses_by_type = (
            self._count_viruses(snapshot)
        )
    ...
    def _count_viruses(
        ...
        for virus in snapshot.viruses.values():

            virus_type = virus.get(
